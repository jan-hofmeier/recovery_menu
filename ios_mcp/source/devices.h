...
int getPhysicalDeviceHandle(uint32_t device);

int slcRead1_original(void *physical_device_info, uint32_t offset_high, uint32_t offset_low, uint32_t cnt, uint32_t block_size, void *data_outptr, read_write_callback_t callback, int callback_parameter);
int sdcardRead_original(void *physical_device_info, uint32_t offset_high, uint32_t offset_low, uint32_t cnt, uint32_t block_size, void *data_outptr, read_write_callback_t callback, int callback_parameter);
